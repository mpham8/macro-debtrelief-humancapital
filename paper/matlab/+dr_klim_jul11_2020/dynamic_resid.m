...
if T_flag
    T = dr_klim_jul11_2020.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(12, 1);
    ...
    residual(5) = (y(8)) - (params(9)*y(10)+T(3)*(y(17)*T(8)+T(6)*params(1)*T(4)*(1-x(it_, 2))*y(18)));
    residual(6) = (y(9)) - (y(7)+y(2)*(1-params(3))-y(2)*T(9));
    residual(7) = (y(10)) - (y(17)*T(3)*(y(6)-params(7)));
    residual(8) = (y(13)) - (params(9)*y(9));
