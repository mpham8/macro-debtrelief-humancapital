...
if T_flag
    T = dr_ylim_jul8_2020.static_g1_tt(T, y, x, params);
end
g1 = zeros(12, 12);
g1(1,1)=1;
...
g1(5,6)=1-T(2)*T(5);
g1(5,7)=(-(T(2)*(y(6)*T(4)*2*y(5)/y(7)*(-y(5))/(y(7)*y(7))+params(1)*T(1)*(1-x(2))*y(12)*T(9)+y(12)*params(1)*params(8)*y(8)*T(9))));
g1(5,8)=(-(T(2)*T(6)*y(12)*params(1)*params(8)));
g1(5,12)=(-(T(2)*(T(6)*params(1)*T(1)*(1-x(2))+T(6)*params(1)*params(8)*y(8))));
