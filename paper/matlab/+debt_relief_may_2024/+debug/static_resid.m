...
lhs(5) = y(6);
rhs(5) = params(9)*y(11)+T(4)*(y(6)*T(8)+T(9)*T(10)*params(1)*T(3)*(1-x(2))*y(17));
lhs(6) = y(7);
rhs(6) = y(5)+y(7)*(1-params(4))-y(7)*T(11);
lhs(7) = y(8);
rhs(7) = y(10)*(params(4)+T(5)*(1-T(3)/y(9)));
lhs(8) = y(9);
rhs(8) = T(4)*(y(9)*T(12)+T(13)*T(1)*y(17)*(params(2)-params(10))*T(3)*(1-x(2)));
lhs(9) = y(10);
rhs(9) = y(8)+y(10)*(1-params(4))-y(10)*T(14);
lhs(10) = y(11);
rhs(10) = T(3)*T(4)*(y(4)-params(7));
lhs(11) = y(14);
rhs(11) = y(7)*params(9);
lhs(12) = y(12);
rhs(12) = y(14)-y(2);
