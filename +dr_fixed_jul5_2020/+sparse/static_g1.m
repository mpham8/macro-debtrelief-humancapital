...
[T_order, T] = dr_fixed_jul5_2020.sparse.static_g1_tt(y, x, params, T_order, T);
g1_v = NaN(29, 1);
g1_v(1)=1;
g1_v(2)=1;
g1_v(3)=1-(1+params(7));
...
g1_v(8)=(-(T(2)*T(6)*y(11)*(1-x(2))*params(1)*T(8)));
g1_v(9)=(-(T(1)*T(2)));
g1_v(10)=(-(T(2)*y(6)));
g1_v(11)=(-1);
g1_v(12)=(-1);
...
g1_v(20)=(-T(3));
g1_v(21)=(-(T(2)*(y(6)*T(4)*2*y(5)/y(7)*(-y(5))/(y(7)*y(7))+params(1)*T(1)*(1-x(2))*y(11)*getPowerDeriv(y(7),params(1)-1,1))));
g1_v(22)=1-(1-params(3)-(T(7)+y(7)*T(4)*2*(y(5)/y(7)-params(3))*(-y(5))/(y(7)*y(7))));
g1_v(23)=1;
g1_v(24)=1-(0>y(9)-y(8));
g1_v(25)=1;
g1_v(26)=1-(1-(0>y(9)-y(8)));
g1_v(27)=1;
g1_v(28)=(-(T(2)*T(6)*params(1)*T(1)*(1-x(2))));
g1_v(29)=1;
