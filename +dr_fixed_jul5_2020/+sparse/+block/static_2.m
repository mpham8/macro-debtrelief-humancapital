...
g1_v(10)=(-1);
g1_v(11)=1;
g1_v(12)=(-(T(2)*y(6)*params(5)/2*1/y(7)*2*y(5)/y(7)));
g1_v(13)=(-(1-y(7)*params(5)/2*1/y(7)*2*(y(5)/y(7)-params(3))));
g1_v(14)=(-(params(3)+1/params(5)*(1-T(1)/y(6))));
g1_v(15)=(-(T(2)*(y(6)*params(5)/2*2*y(5)/y(7)*(-y(5))/(y(7)*y(7))+params(1)*T(1)*(1-x(2))*y(11)*getPowerDeriv(y(7),params(1)-1,1))));
g1_v(16)=1-(1-params(3)-(T(5)+y(7)*params(5)/2*2*(y(5)/y(7)-params(3))*(-y(5))/(y(7)*y(7))));
g1_v(17)=(-(x(1)*getPowerDeriv(y(7),params(1),1)));
g1_v(18)=1;
g1_v(19)=1-(0>y(9)-y(8));
