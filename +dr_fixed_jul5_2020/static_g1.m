...
if T_flag
    T = dr_fixed_jul5_2020.static_g1_tt(T, y, x, params);
end
g1 = zeros(11, 11);
g1(1,1)=1;
...
g1(4,7)=(-T(3));
g1(5,3)=(-(T(2)*T(6)*y(11)*(1-x(2))*params(1)*T(8)));
g1(5,5)=(-(T(2)*y(6)*T(4)*1/y(7)*2*y(5)/y(7)));
g1(5,6)=1-T(2)*T(5);
g1(5,7)=(-(T(2)*(y(6)*T(4)*2*y(5)/y(7)*(-y(5))/(y(7)*y(7))+params(1)*T(1)*(1-x(2))*y(11)*getPowerDeriv(y(7),params(1)-1,1))));
g1(5,11)=(-(T(2)*T(6)*params(1)*T(1)*(1-x(2))));
