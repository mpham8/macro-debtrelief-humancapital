...
residual = zeros(17, 1);
    ...
    residual(5) = (y(6)) - (params(9)*y(11)+T(4)*(y(6)*T(8)+T(9)*T(10)*params(1)*T(3)*(1-x(2))*y(17)));
    residual(6) = (y(7)) - (y(5)+y(7)*(1-params(4))-y(7)*T(11));
    residual(7) = (y(8)) - (y(10)*(params(4)+T(5)*(1-T(3)/y(9))));
    residual(8) = (y(9)) - (T(4)*(y(9)*T(12)+T(13)*T(1)*y(17)*(params(2)-params(10))*T(3)*(1-x(2))));
    residual(9) = (y(10)) - (y(8)+y(10)*(1-params(4))-y(10)*T(14));
    residual(10) = (y(11)) - (T(3)*T(4)*(y(4)-params(7)));
    ...
    residual(16) = (y(16)) - (x(1)*y(10)^params(10));
    residual(17) = (y(17)) - (x(1));
