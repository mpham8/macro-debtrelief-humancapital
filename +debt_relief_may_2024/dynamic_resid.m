...
if T_flag
    T = debt_relief_may_2024.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(17, 1);
    ...
    residual(5) = (y(9)) - (params(9)*y(14)+T(5)*(y(23)*T(12)+T(9)*T(8)*params(1)*T(6)*(1-x(it_, 2))*y(26)));
    residual(6) = (y(10)) - (y(8)+y(2)*(1-params(4))-y(2)*T(13));
    residual(7) = (y(11)) - (y(3)*(params(4)+T(7)*(1-T(4)/y(12))));
    residual(8) = (y(12)) - (T(5)*(y(25)*T(16)+T(15)*T(14)*(params(2)-params(10))*T(6)*(1-x(it_, 2))*y(26)));
    residual(9) = (y(13)) - (y(11)+y(3)*(1-params(4))-y(3)*T(17));
    residual(10) = (y(14)) - (T(6)*T(5)*(y(7)-params(7)));
    ...
    residual(16) = (y(19)) - (x(it_, 1)*T(18));
    residual(17) = (y(20)) - (x(it_, 1));
