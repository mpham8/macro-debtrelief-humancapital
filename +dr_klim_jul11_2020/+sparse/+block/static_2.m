...
g1_v(4)=(-(T(2)*y(6)));
g1_v(5)=(-1);
g1_v(6)=T(6)-T(2)*(1+y(4))*T(6);
g1_v(7)=(-(y(7)*1/params(5)*(-(T(6)/y(6)))));
g1_v(8)=(-(T(2)*T(4)*y(12)*params(1)*(1-x(2))*T(6)));
g1_v(9)=(-(params(3)+1/params(5)*(1-T(1)/y(6))));
g1_v(10)=(-(T(2)*(y(6)*params(5)/2*2*y(5)/y(7)*(-y(5))/(y(7)*y(7))+params(1)*T(1)*(1-x(2))*y(12)*getPowerDeriv(y(7),params(1)-1,1))));
g1_v(11)=1-(1-params(3)-(T(5)+y(7)*params(5)/2*2*(y(5)/y(7)-params(3))*(-y(5))/(y(7)*y(7))));
g1_v(12)=(-params(9));
...
g1_v(18)=(-(y(7)*1/params(5)*(-((-T(1))/(y(6)*y(6))))));
g1_v(19)=1-T(2)*T(3);
g1_v(20)=(-(T(2)*(y(4)-params(7))));
g1_v(21)=1;
g1_v(22)=(-1);
g1_v(23)=1;
g1_v(24)=1-(1-(0>y(9)-y(8)));
g1_v(25)=(-params(9));
g1_v(26)=1;
g1_v(27)=1-(0>y(9)-y(8));
g1_v(28)=1;
